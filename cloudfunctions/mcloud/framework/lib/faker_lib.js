...
/** 兴趣 */
function getLike(isNullable = false, ex = '') {
	let data = ["阅读", "运动", "音乐", "旅行", "摄影", "绘画", "烹饪", "看电影", "玩游戏", "健身", "跳舞", "写作", "手工制作", "瑜伽", "钓鱼", "徒步旅行", "园艺", "宠物养护", "集邮", "收藏", "历史研究", "考古", "地理探险", "语言学习", "编程", "电子游戏", "桌游", "模型制作", "汽车", "摩托车", "自行车", "飞行", "航海", "潜水", "冲浪", "滑雪", "滑冰", "极限运动", "魔术", "表演", "演讲", "辩论", "社交", "志愿服务", "公益活动", "冥想", "哲学思考", "时尚", "美容", "化妆", "美甲", "美发", "健康养生", "营养学", "心理学", "教育", "培训"];
	return getRnd(data, isNullable, ex);
}
